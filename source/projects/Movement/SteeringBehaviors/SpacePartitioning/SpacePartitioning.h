...
public:
	...
	bool SetDebug(bool val) { m_CanDebug = val; return m_CanDebug; };

	void SetSpaceSize(float width, float height) { m_SpaceWidth = width; m_SpaceHeight = height; };
